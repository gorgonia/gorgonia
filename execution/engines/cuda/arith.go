...
func (e *Engine[DT, T]) Add(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
...
func (e *Engine[DT, T]) Sub(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
...
func (e *Engine[DT, T]) Mul(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
...
func (e *Engine[DT, T]) Div(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
...
func (e *Engine[DT, T]) Pow(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
...
func (e *Engine[DT, T]) Mod(ctx context.Context, a, b, retVal T, opts ...tensor.FuncOpt) (err error) {
