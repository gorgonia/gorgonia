...
travis retry sudo apt-get upgrade -qq
export CUDA_APT=${CUDA:0:3}
export CUDA_APT=${CUDA_APT/./-}
travis retry sudo apt-get install -f -y nvidia-375 nvidia-375-dev libcuda1-375 nvidia-settings nvidia-opencl-icd-375
