...
// DataSize returns 1 for all scalar Values
func (v *F64) DataSize() int { return 1 }

// DataSize returns 1 for all scalar Values
func (v *F32) DataSize() int { return 1 }

// DataSize returns 1 for all scalar Values
func (v *I) DataSize() int { return 1 }

// DataSize returns 1 for all scalar Values
func (v *I64) DataSize() int { return 1 }

// DataSize returns 1 for all scalar Values
func (v *I32) DataSize() int { return 1 }
...
// IsManuallyManaged returns true for all scalar Values
func (v *F64) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *F32) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *I) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *I64) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *I32) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *U8) IsManuallyManaged() bool { return true }

// IsManuallyManaged returns true for all scalar Values
func (v *B) IsManuallyManaged() bool { return true }
