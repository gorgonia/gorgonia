...
// Zeroes create a ndarray of a given shape and fills it with int(0) (which is Go's default value)
...
func WithBacking(a []int) consOpt {
	f := func(t *Tensor) {
		t.data = a
	}
	return f
...
func (t *Tensor) Dtype() types.Dtype { return types.Int }
