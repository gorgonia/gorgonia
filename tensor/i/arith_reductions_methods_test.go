...
func TestTreduce(t *testing.T) {
	...
	*/
	...
	expectedData = []int{6, 8, 10, 12, 14, 16}
	...
	expectedData = []int{1, 5, 9, 13, 17, 21}
	assert.Equal(expectedShape, T2.Shape())
	assert.Equal(expectedData, T2.data)
