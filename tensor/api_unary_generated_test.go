...
var signTests = []struct {
	...
	{[]uint{0, 1, 2, 3, 4}, []uint{100, 10, 20, 30, 40}, []uint{0, 1, 1, 1, 1}, []uint{0, 1, 1, 1}},
	{[]uint8{0, 1, 2, 3, 4}, []uint8{100, 10, 20, 30, 40}, []uint8{0, 1, 1, 1, 1}, []uint8{0, 1, 1, 1}},
	{[]uint16{0, 1, 2, 3, 4}, []uint16{100, 10, 20, 30, 40}, []uint16{0, 1, 1, 1, 1}, []uint16{0, 1, 1, 1}},
	{[]uint32{0, 1, 2, 3, 4}, []uint32{100, 10, 20, 30, 40}, []uint32{0, 1, 1, 1, 1}, []uint32{0, 1, 1, 1}},
	{[]uint64{0, 1, 2, 3, 4}, []uint64{100, 10, 20, 30, 40}, []uint64{0, 1, 1, 1, 1}, []uint64{0, 1, 1, 1}},
