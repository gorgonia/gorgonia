...
var bnAllCases = []struct {
	...
	},
	{
		...
		ExpectedScaleGrad:   []float32{2.0435872e-08, -9.5366826e-09, -1.9073365e-08, -1.2715577e-08},
	...
	},
	{
		...
		ExpectedScaleGrad:   []float64{3.806467432995452e-17, -2.7068212856856613e-17, 2.1992922946195812e-17, -5.075289910660803e-18},
	...
	},
	{
		...
		ExpectedScaleGrad:   []float64{2.4195790855916406e-17, -4.004820555462041e-17},
	...
	},
	{
		...
		ExpectedScaleGrad:   []float32{-5.3207936e-09, -5.3207936e-09},
	...
	},
	{
		...
		ExpectedScaleGrad:   []float64{0.24576956790841079, 0.2457695679084171, 0.2457695679084172},
		ExpectedInputGrad:   []float64{-0.004601993984850204, -0.0010391599719692425, 0.00252367404091172, 0.0060865080537926865, -0.009203987969700358, -0.002078319943938444, 0.005047348081823482, 0.012173016107585397, -0.013805981954550557, -0.0031174799159076816, 0.007571022122735195, 0.01825952416137807, -0.006086508053792681, -0.00252367404091172, 0.0010391599719692425, 0.00460199398485021, -0.012173016107585387, -0.005047348081823472, 0.0020783199439384542, 0.009203987969700369, -0.0182595241613781, -0.0075710221227352275, 0.003117479915907647, 0.013805981954550522},
...
var bnstackedCases = []struct {
...
}{
	{
		...
		ExpectedEvalResult:  []float32{0.18339723, 0.43156812, 0.19526128, 0.4617111, 0.20712532, 0.491854},
	},
	{
		...
		ExpectedEvalResult:  []float64{0.18238597331399445, 0.4315682494076721, 0.19457929957404266, 0.461711271530049, 0.2067726258340909, 0.49185429365242606},
	},
}
