...
var bnAllCases = []struct {
	...
	},
	{
		...
		ExpectedBiasGrad:    []float32{0.5, 0.5},
		ExpectedScaleGrad:   []float32{3.489054e-07, 1.0467166e-06},
	...
	},
	{
		...
		ExpectedScaleGrad:   []float32{1.986263e-08, 2.6042684e-08, -7.8128046e-08},
...
var bnstackedCases = []struct {
...
}{
	{
		...
		ExpectedEvalResult:  []float32{0.18485457, 0.43156818, 0.19797754, 0.46171117, 0.21110049, 0.49185407},
	},
	{
