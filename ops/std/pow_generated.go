...
func (op Pow) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
...
// Do performs elementwise exponentiation.
func (op PowVS) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
// Do performs elementwise exponentiation.
func (op PowSV) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
