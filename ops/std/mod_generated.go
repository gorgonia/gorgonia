...
func (op Mod) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
...
// Do performs elementwise mod.
func (op ModVS) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
// Do performs elementwise mod.
func (op ModSV) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
