...
func (op lteVV) String() string { return "≤" }
...
func (op lteVV) Do(ctx context.Context, vs ...values.Value) (retVal values.Value, err error) {
...
func (op lteVV) PreallocDo(ctx context.Context, prealloc values.Value, vs ...values.Value) (retVal values.Value, err error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
func (op lteVV) DiffWRT(inputs int) []bool { return twofalses } // lteVS is a tensor-scalar elementwise less-than-or-equal-to.
type lteVS struct {
	binopVS
	retSame bool
}
...
func (op lteVS) DiffWRT(inputs int) []bool { return twofalses } // lteSV is a scalar-tensor elementwise less-than-or-equal-to.
type lteSV struct {
	binopSV
	retSame bool
}
...
func (op lteSV) DiffWRT(inputs int) []bool { return twofalses }
