...
func (op elNeVV) String() string { return "≠" }
...
func (op elNeVV) Do(ctx context.Context, vs ...values.Value) (retVal values.Value, err error) {
...
func (op elNeVV) PreallocDo(ctx context.Context, prealloc values.Value, vs ...values.Value) (retVal values.Value, err error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
func (op elNeVV) DiffWRT(inputs int) []bool { return twofalses } // elNeVS is a tensor-scalar elementwise not-equal-to.
type elNeVS struct {
	binopVS
	retSame bool
}
...
func (op elNeVS) DiffWRT(inputs int) []bool { return twofalses } // elNeSV is a scalar-tensor elementwise not-equal-to.
type elNeSV struct {
	binopSV
	retSame bool
}
...
func (op elNeSV) DiffWRT(inputs int) []bool { return twofalses }
