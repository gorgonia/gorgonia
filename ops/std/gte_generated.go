...
func (op gteVV) String() string { return "≥" }
...
func (op gteVV) Do(ctx context.Context, vs ...values.Value) (retVal values.Value, err error) {
...
func (op gteVV) PreallocDo(ctx context.Context, prealloc values.Value, vs ...values.Value) (retVal values.Value, err error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
func (op gteVV) DiffWRT(inputs int) []bool { return twofalses } // gteVS is a tensor-scalar elementwise greater-than-or-equal-to.
type gteVS struct {
	binopVS
	retSame bool
}
...
func (op gteVS) DiffWRT(inputs int) []bool { return twofalses } // gteSV is a scalar-tensor elementwise greater-than-or-equal-to.
type gteSV struct {
	binopSV
	retSame bool
}
...
func (op gteSV) DiffWRT(inputs int) []bool { return twofalses }
