...
func (op Sub) Do(ctx context.Context, vs ...values.Value) (retVal values.Value, err error) {
...
func (op Sub) PreallocDo(ctx context.Context, prealloc values.Value, vs ...values.Value) (retVal values.Value, err error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
