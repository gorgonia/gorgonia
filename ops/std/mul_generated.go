...
func (op Mul) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
...
// Do performs elementwise multiplciatio=.
func (op MulVS) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
// Do performs elementwise multiplciatio=.
func (op MulSV) Do(ctx context.Context, vs ...values.Value) (values.Value, error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
