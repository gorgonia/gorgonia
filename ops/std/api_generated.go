...
func Add(a, b ops.Operand) ops.PreallocOp {
...
func Sub(a, b ops.Operand) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Mul(a, b ops.Operand) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Div(a, b ops.Operand) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Pow(a, b ops.Operand) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Mod(a, b ops.Operand) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Lt(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Lte(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Gt(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func Gte(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func ElEq(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
...
func ElNe(a, b ops.Operand, retSame bool) ops.PreallocOp {
	aScalar := a.Shape().IsScalar()
	bScalar := b.Shape().IsScalar()
