...
func (op ltVV) String() string { return "<" }
...
func (op ltVV) Do(ctx context.Context, vs ...values.Value) (retVal values.Value, err error) {
...
func (op ltVV) PreallocDo(ctx context.Context, prealloc values.Value, vs ...values.Value) (retVal values.Value, err error) {
	if err := handleCtx(ctx); err != nil {
		return nil, err
	}
...
func (op ltVV) DiffWRT(inputs int) []bool { return twofalses } // ltVS is a tensor-scalar elementwise less-than.
type ltVS struct {
	binopVS
	retSame bool
}
...
func (op ltVS) DiffWRT(inputs int) []bool { return twofalses } // ltSV is a scalar-tensor elementwise less-than.
type ltSV struct {
	binopSV
	retSame bool
}
...
func (op ltSV) DiffWRT(inputs int) []bool { return twofalses }
