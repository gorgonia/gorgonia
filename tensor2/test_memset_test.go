...
func (a f64sDummy) Memset(any interface{}) error {
	var v float64
...
func (a f32sDummy) Memset(any interface{}) error {
	var v float32
...
func (a intsDummy) Memset(any interface{}) error {
	var v int
...
func (a i64sDummy) Memset(any interface{}) error {
	var v int64
...
func (a i32sDummy) Memset(any interface{}) error {
	var v int32
...
func (a u8sDummy) Memset(any interface{}) error {
	var v byte
...
func (a bsDummy) Memset(any interface{}) error {
	var v, ok bool
	if v, ok = any.(bool); !ok {
