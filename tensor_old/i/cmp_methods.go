...
func scalarCmpBacking(op cmpOp, left bool, val int, data []int) (backing []bool, err error) {
...
func (t *Tensor) scalarCmp(op cmpOp, left bool, val int) (retVal *tb.Tensor, err error) {
	var backing []bool
