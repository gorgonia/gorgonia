...
func TestPointwiseSquare(t *testing.T) {
	...
	backingA := []float64{1, 2, -3, 4}
	backingR := []float64{1, 3, 5, 6}
	correct = []float64{1, 4, 9, 16}
...
func TestSqrt(t *testing.T) {
	...
	correct = make([]float64, len(backingA))
...
func TestSign(t *testing.T) {
	...
	backingA := []float64{1, 2, -2, -1}
	backingR := []float64{1, 3, 5, 6}
	correct = []float64{1, 1, -1, -1}
